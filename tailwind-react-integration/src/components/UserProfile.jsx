...
return (
    <div className="UserProfile">
        ...
        <div className="group">
            <img src="https://via.placeholder.com/150" className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out" alt="John Doe, a developer, smiling in a circular profile photo against a neutral background" />
            <h1 className="text-xl text-blue-800 my-4 hover:text-blue-500 vertical-margin sm:text-lg md:text-xl">John Doe</h1>
