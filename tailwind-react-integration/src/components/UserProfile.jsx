...
return (
    <div className="UserProfile">
        ...
        <div className="group">
            <img src="https://via.placeholder.com/150" className="rounded-full sm:w-24 h-24 md:w-36 h-36 mx-auto" alt="John Doe, a developer, smiling in a circular profile photo against a neutral background" />
